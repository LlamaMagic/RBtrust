...
public class AnamnesisAnyder : AbstractDungeon
{
    ...
    public override async Task<bool> RunAsync()
    {
        ...
        {
            BattleCharacter UnknownNpc = GameObjectManager.GetObjectsByNPCId<BattleCharacter>(UnknownA)
                .FirstOrDefault(bc => bc.IsTargetable);

            SidestepPlugin.Enabled = true;
            AvoidanceHelpers.AddAvoidRectangle(UnknownNpc, 12.0f, 40.0f);
        ...
        {
            BattleCharacter UnknownNpc = GameObjectManager.GetObjectsByNPCId<BattleCharacter>(UnknownB)
                .FirstOrDefault(bc => bc.IsTargetable);
